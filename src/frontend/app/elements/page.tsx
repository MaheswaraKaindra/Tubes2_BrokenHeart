  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-[#F9F9F9]">
      ...
      <main className="container relative mx-auto max-w-4xl px-4 py-8">
        ...
        {/* Element grid */}
        <div className="grid grid-cols-2 gap-4 rounded-xl bg-[#E8DBF2]/50 p-4 shadow-md sm:grid-cols-4 md:p-6">
          {Array.from({ length: 8 }).map((_, index) => (
            <div key={index} className="aspect-square rounded-lg bg-white p-2 shadow-sm transition-all hover:shadow-md">
              {/* Element placeholder */}
            </div>
          ))}
        </div>
